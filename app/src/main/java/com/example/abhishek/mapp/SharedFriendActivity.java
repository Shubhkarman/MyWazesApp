...
public class SharedFriendActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shared_friend);
        ...
        btnsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bindedService.sendMessageToServer(utils.getSendSharedRequestJSON(emailid.getText().toString()));
            }
        });
    }
    ...
    private void parseMessage(final String msg) {
        ...
        try {
            ...
            String success="Success",fail="Fail",sharedconfirm="sharedconfirm",failae="FailAE",sharedrequest="sharedrequest",sharedmapstart="sharedmapstart",sharedmapupdate="sharedmapupdate";
            ...
            //if(sessionId.equals(utils.getSessionId().toString())) {
                if (what.equals(sharedrequest)) {
                    String fromid = jObj.getString("fromid");
                    String sharedid = jObj.getString("message");
                    showToast("Shared Request From " + fromid);
                    DialogSharedAppear(fromid, "Shared Request", sharedid);
                    ...
                    if (message.equals("Delete")) {
                        showToast("Shared Map Request was rejected");
                    }
                    else if (message.equals("Confirm")) {
                        Intent i = new Intent(this, SharedMapActivity.class);
                        startActivity(i);
                    }
...
//	}
    ...
    private void DialogSharedAppear(final String fromid, final String Title, final String sharedid) {

        final String sharedrequest = "Shared Request";
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if (Title.equals(sharedrequest)) {
                    bindedService.sendMessageToServer(utils.getSendSharedConfirmJSON(fromid, "Success",sharedid));
                }
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (Title.equals(sharedrequest)) {
                    bindedService.sendMessageToServer(utils.getSendSharedConfirmJSON(fromid, "Fail",sharedid));
                }
