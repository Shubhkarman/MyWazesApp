	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSend.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(inputpassword.getEditableText().toString()==confirmpassword.getEditableText().toString()){
					...
					sendMessageToServer(utils.getSendSignupMessageJSON(inputemail.getText().toString(),
